...
function Introduction() {
  return (
    ...
    <h2 className="text-2xl font-semibold mt-6 mb-2">What is HTML?</h2>
    ...
    <h2 className="text-2xl font-semibold mt-6 mb-2">Why Learn HTML?</h2>
    <ul className="list-disc list-inside mb-4 space-y-2">
    ...
    <h2 className="text-2xl font-semibold mt-6 mb-2">Basic Structure of an HTML Document</h2>
    <p className="mb-4 text-gray-300">An HTML document typically consists of the following parts:</p>
    ...
    <p className="text-gray-300">HTML is the starting point for anyone interested in web development. By mastering HTML, you’ll gain the skills needed to create structured, well-organized web pages. From there, you can expand your knowledge by learning CSS for styling and JavaScript for interactivity.</p>
  </div>
  );
}
